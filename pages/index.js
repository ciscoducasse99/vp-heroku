    ...
    <Layout>
        ...
        <div id="home-main-section" className="m-0 p-0">
            <div id="home-page-header" className="text-center">
                ...
                <p className="col-11 col-xl-5 mx-auto pb-5" id="p-header">Express yourself with a modern and innovative website to provide a platform for your new clients and your community, <a className="text-white">for free. </a></p>
                <Sphere />
