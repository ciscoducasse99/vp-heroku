...
const Privacy = () => (
    <Layout>
        <Head>
            <title>Privacy | The Vision Project</title>
        </Head>
        ...
        <div id="page-content">
            ...
            <div className="container pb-3">
                ...
                <p>We use your data to provide and improve the Service. By using the Service, you agree to the collection and use of information in accordance with this policy. Unless otherwise defined in this Privacy Policy, the terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, accessible from www.thevisionproject.com</p>

                <div id="defs" className="py-3">
                <h2>Definitions</h2>
                <ul>
                    <li>
                        <p><strong>Service</strong></p>
                        <p>Service is the www.thevisionproject.com website operated by The Vision Project</p>
                    </li>
                    <li>
                ...
                <div id="uod" className="py-3">
                <h2>Use of Data</h2>

                <p>The Vision Project uses the collected data for various purposes:</p>
                <ul>
                ...
                <div id="tod" className="py-3">
                <h2>Transfer Of Data</h2>
                <p>Your information, including Personal Data, may be transferred to - and maintained on - computers located outside of your state, province, country or other governmental jurisdiction where the data protection laws may differ than those from your jurisdiction.</p>
                <p>If you are located outside United States and choose to provide information to us, please note that we transfer the data, including Personal Data, to United States and process it there.</p>
                <p>Your consent to this Privacy Policy followed by your submission of such information represents your agreement to that transfer.</p>
                <p>The Vision Project will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information.</p>
                </div>

                <div id="dod" className="py-3">
                <h2>Disclosure Of Data</h2>

                <h3>Legal Requirements</h3>
                <p>The Vision Project may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
                <ul>
                    <li>To comply with a legal obligation</li>
                    <li>To protect and defend the rights or property of The Vision Project</li>
                ...
                <div id="con-us" className="py-3">
                <h2>Contact Us</h2>
                <p>If you have any questions about this Privacy Policy, please contact us:</p>
                <ul>
                    <li>By email: fducasse@mail.middlesex.edu</li>
